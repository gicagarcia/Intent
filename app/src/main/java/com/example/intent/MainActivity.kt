...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pcarl = registerForActivityResult(ActivityResultContracts.RequestPermission()){ permissaoConcedida ->
            if(permissaoConcedida){
                chamarNumero(chamar = true)
            }
            else{
                Toast.makeText(this, "Permissao necessaria para continuar", Toast.LENGTH_SHORT).show()
            }
